"""
Django settings for chatwork_webhook project.
...
SECRET_KEY = 'wrwvu1x0d&4dab$uylrq^=azmt57m#aovkhf#mgkuq(qqh!wz-'
...
WSGI_APPLICATION = 'chatwork_webhook.wsgi.application'
